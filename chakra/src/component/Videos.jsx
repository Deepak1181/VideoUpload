  ...
  return (
    <Stack direction={['column', 'row']} >
      ...
      <VStack w={"full"} alignItems={"flex-start"} p={"8"} overflow={"auto"} >
        ...
        <Text>Lorem ipsum dolor sit amet consectetur adipisicing elit. Error excepturi molestiae iure omnis nam corporis tempora eius tempore, est dolores non, autem, aliquid nostrum incidunt!</Text>
      </VStack>
      ...
      { videosArr.map((item,index)=>(
        <Button variant={"ghost"} colorScheme='purple' onClick={()=>setVideoSrc(item)}>Leacture {index+1}</Button>
      ))
